...
-- pensar, de certa forma, sempre um "passo á frente" e compreender as implicações que os parâmetros que
...
-- e a que cada carater corrospondia, a descomprime tornou-se uma espécie de função inversa á comprime.
